return {
...

  {
    ...
    keys = {
      { '<leader>gy', '<cmd>lua require("gitlinker").get_buf_range_url("n")<CR>',      mode = "n", { silent = false } }, -- copy github link
      { '<leader>gy', '<cmd>lua require("gitlinker").get_buf_range_url("v")<CR><ESC>', mode = "v", { silent = false } }  -- copy github link
    },
    dependencies = 'nvim-lua/plenary.nvim',
  },
